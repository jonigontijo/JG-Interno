...
export default function TechPage() {
  ...
  const [newTask, setNewTask] = useState({ title: "", clientId: "", assignee: "", deadline: "", urgency: "normal" as Task["urgency"], type: "Desenvolvimento", description: "", recurUntil: "" });
  ...
  const handleCreate = () => {
    ...
    setShowModal(false);
    setNewTask({ title: "", clientId: "", assignee: "", deadline: "", urgency: "normal", type: "Desenvolvimento", description: "", recurUntil: "" });
  };
